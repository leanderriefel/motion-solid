...
- For high-complexity cases (nested presence, shared `layoutId`, scroll roots, and grid reflow), see `/docs/demos` examples: **Complex Layout Board**, **Nested Presence + Shared layoutId**, and **Scroll + Sticky Layout**
